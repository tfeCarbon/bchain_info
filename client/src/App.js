...
import FarmSignUp from "./aFarmer/FarmSignUp";
import FarmSignIn from "./aFarmer/FarmSignIn";
import InSignIn from "./aInsurance/InSignIn";
import InSignUp from "./aInsurance/InSignUp";
import FarmerInfo from "./aFarmer/FarmInfo";
    ...
    getAccount = async () => {
        if(this.state.web3 !== null || this.state.web3 !== undefined) {
            await window.ethereum.on('accountsChanged', async (accounts) => {
                ...
                this.state.web3.eth.getBalance(accounts[0], 'latest', (err, balance) => {
                    if(!err) {
                        this.setState({
